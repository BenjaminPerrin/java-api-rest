...
//    @Produces("text/plain")
    ...
    public String getBooks() {
        ...
        return "Java 8 docs / Angular pour les nuls / les voyages lesp lus fou";
    }
    ...
    public String getBorrowedBooks() {
        ...
        return "Angular pour les nuls  / les voyages lesp lus fou";
    }
    ...
    public String getDetailsTextBookById(@PathParam("id") int id){
        ...
        return "le detail du libre numero : "+ id +" - il s'agit d'une autobiographie";
    }
    ...
    public String getDetailsXmlBookById(@PathParam("id") int id){
        ...
        return "<?xml version=\"1.0\"?>"+
                "<details>le detail du libre numero : "+ id
                +" - il s'agit d'une autobiographie</details>";
    }
...
"               </head>\n" +
            "    <body>\n" +
            "        <h1>\n" +
"                \"le detail du libre numero : \""+ id+"\n" +
"                \" - il s'agit d'une autobiographie\";</h1>\n" +
            "    </body>\n" +
            "</html>";
    }
